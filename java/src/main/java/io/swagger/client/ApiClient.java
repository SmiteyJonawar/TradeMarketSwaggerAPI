...
public class ApiClient {
    ...
    private String basePath = "https://virtserver.swaggerhub.com/Jonawar/HelloWorldBuNoGoodbye/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://virtserver.swaggerhub.com/Jonawar/HelloWorldBuNoGoodbye/v1
